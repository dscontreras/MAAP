...
% SQUARES will have some amount of squares. Access each square as you would any array. Access the elements of the squares by getting the BoundingBox. 
% The BoundingBox is of the form [xmin ymin width height]
function [squares] = location_squares(img)
